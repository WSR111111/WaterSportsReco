...
export const getPlaces = async (params = {}) => {
  try {
    ...
    return { places: [], success: false, error: error.message };
  }
};
...
export const getMapPlaces = async (params = {}) => {
  try {
    ...
    return { 
      ...
      success: response.data.success,
      count: placesWithCoords.length
    };
  } catch (error) {
    console.error("지도용 레저 장소 조회 실패:", error);
    return { places: [], success: false, error: error.message };
  }
};
...
export const getMarineObservations = async (params = {}) => {
  try {
    ...
    console.error("해양 관측 데이터 조회 실패:", error);
    return { stations: [], success: false, error: error.message };
  }
};
...
export const getSurfaceObservations = async (params = {}) => {
  try {
    ...
    console.error("지상 관측 데이터 조회 실패:", error);
    return { stations: [], success: false, error: error.message };
  }
};
...
export const getObservationStations = async (params = {}) => {
  try {
    ...
    console.error("관측소 목록 조회 실패:", error);
    return { stations: [], success: false, error: error.message };
  }
};
...
export const getMarineStations = async () => {
  try {
    ...
    console.error("해양 관측소 조회 실패:", error);
    return { stations: [], success: false, error: error.message };
  }
};
...
export const getSurfaceStations = async () => {
  try {
    ...
    console.error("지상 관측소 조회 실패:", error);
    return { stations: [], success: false, error: error.message };
  }
};
...
export const getSports = async () => {
  try {
    ...
    console.error("스포츠 카테고리 조회 실패:", error);
...
export const getRegions = async () => {
  try {
    ...
    return { regions: [], success: false, error: error.message };
  }
};
...
export const getPlaceDetail = async (contentId) => {
  try {
    ...
    return { place: null, success: false, error: error.message };
  }
};
